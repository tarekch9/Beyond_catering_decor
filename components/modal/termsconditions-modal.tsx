        ...
        <div className="mx-auto bg-black p-20 rounded-lg shadow text-[#f2f1f0]/90 max-w-2xl h-screen overflow-y-auto">
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              accordance with these Terms & Conditions. You must not use our
              services in any way that could damage, disable, or impair our
              services.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              not limited to software, databases, text, graphics, and logos, are
              the property of our company and are protected by intellectual
              property laws.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              of our services, even if we have been advised of the possibility
              of such damages.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              at any time. Your continued use of our services after any changes
